...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-soft btn-floating",
        destructive:
        ...
        hero: "gradient-primary text-white hover:scale-105 shadow-elegant font-heading font-semibold",
        soft: "bg-primary-light text-primary hover:bg-primary/20 shadow-soft",
        floating: "gradient-card border border-border/50 shadow-floating hover:shadow-elegant backdrop-blur-sm",
      },
      size: {
